...
enum KRProgressHUDIconType {
    ...
    func getColor() -> CGColor {
        switch self {
        case .success:  return UIColor.black.cgColor
        case .info:  return UIColor.black.cgColor
        case .warning:  return UIColor.black.cgColor
        case .error:  return UIColor.black.cgColor
        }
    }
}
